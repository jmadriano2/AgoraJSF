...
public class User {
    ...
    public User(int user_id, String user_name, String user_fname, String user_lname, String user_password,
                String user_dateJoined, String user_email, String user_nickname) {
